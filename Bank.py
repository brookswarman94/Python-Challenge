...
data_budget = os.path.join('downloads','budget_data.csv')
...
with open(data_budget) as revenue_data:
    ...
    print("Average Change: " + "$" + str(round(sum(revenue_changes) / (total_months))))
